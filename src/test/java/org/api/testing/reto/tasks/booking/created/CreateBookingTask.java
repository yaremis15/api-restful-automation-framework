package org.api.testing.reto.tasks.booking.created;

import net.serenitybdd.screenplay.Actor;
import net.serenitybdd.screenplay.Task;
import net.thucydides.core.annotations.Step;
import org.api.testing.reto.interactions.ExecutePostRequest;
...
import static org.api.testing.reto.utils.environments.Endpoints.CREATE_BOOKING;
...
public class CreateBookingTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        YAREMIS.remember(BOOKING_ID, bookingId);
    }
}
